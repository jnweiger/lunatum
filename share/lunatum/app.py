...
class LunatumApp(GObject.GObject):

    def __init__(self, datadir, dist, debug, silent):
        ...
        self.builder.add_from_file(os.path.join(prefs.datadir, "lunatum", "ui", "lunatum.ui"))
